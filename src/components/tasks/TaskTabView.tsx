        ...
        <div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                <div>
                    ...
                    <div className=" min-h-[425px] h-[425px] rounded-2xl py-4 px-4 xl:px-6 shadow-md overflow-hidden ">
                        <div className='flex flex-col space-y-4 pt-5 h-full w-fit overflow-y-auto '>
                            {milestones.length !== 0 ? (
                                ...
                                <>
                                    <div className="w-full h-full overflow-hidden">
                                        <img className="object-contain max-h-full max-w-full" src={MilestoneGif} alt="jet" />
                                    </div>
