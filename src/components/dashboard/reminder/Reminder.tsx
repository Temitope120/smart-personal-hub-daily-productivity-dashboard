...
const Reminder = () => {
  return (
    <div>
      ...
      <p className='text-[#1B6747] text-2xl sm:text-4xl md:text-2xl xl:text-[1.5rem] 2xl:text-5xl text-wrap font-medium pb-3 sm:pb-4'>
        React Developer Job Interview With ADA <br />
        <span className="font-normal! text-lg sm:text-xl md:text-lg xl:text-[1rem] 2xl:text-2xl text-[#9DABA6]">
          Time 02:00pm - 4:00pm
        </span>
      </p>
